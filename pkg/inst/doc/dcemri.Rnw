...
for (z in 1:Z) {
  image(1:X, 1:Y, mni[,,z], zlim=zrange, col=grey(0:64/64),
        xlab="", ylab="", axes=FALSE)
}
dev.off()
@ 
produces a 3D array of the image data that may be displayed in a
$10{\times}10$ grid of images (Figure~\ref{fig:avg152T1_LR_nifti}).
...
dev.off()
@ 
produces a 3D array of parameter estimates (essentially coefficients
...
\bibliography{/home/bjw34032/Biblio/gsk}
