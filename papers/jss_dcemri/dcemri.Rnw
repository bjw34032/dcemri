...
to treatment of both $\ktrans$ and $\kep$ in DCE-MRI using functional
data analysis \citep{oco-etal:fPCA}.
...
apoptosis after treatment.  \citep{che-etal:diffusion,koh-col:DW-MRI}
...
rich metadata\footnote{\url{http://cabig.nci.nih.gov/tools/NCIA}}.
